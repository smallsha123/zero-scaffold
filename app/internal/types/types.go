...
type PageReq struct {
	...
	PageSize int64 `json:"page_size,default=10,range=[1:100]" form:"page_size,default=10,range=[1:100]"`
}
...
type PageInfo struct {
	Page     int64 `json:"page" validate:"number"`
	PageSize int64 `json:"pageSize" validate:"number,max=100000"`
}
